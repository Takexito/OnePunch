...
namespace JustArc
{
     ...
     * Если вы читаете этот комментарий, то лучше закройте этот код и никогда больше не открывайте!!!
     * 
     * Внимание! Ниже громадная куча велосипедов из костылей!
     * 
     * Если вы пытаетесь понять, что за что отвечает, просто закройте этот код!!!
     * 
     * Внимание! Ниже куча кода, которую по сути надо было вынести в отдельный файл, и т.п. , но почти все в одном месте и это выглядит очень ужасно.
     *  
     * 
     * */
	/// <summary>
	...
	public class Game1 : Game
	{
        ...
        /*
         * Если вы читаете это, то скорее всео вы прочли часть кода выше, могу вас увереть, 
         * это самое безобидное, что вы можете увидить, поэтому лучше просто уходите из этого кода 
         */
        ...
        /*
         * Поздравляю, вы прошли первый  уровень, если вы еще способны соображать, 
         * то послушайте меня и просто закройте код! 
         * Дальше вам предстоит нечто еще страшней, чем было до этого, 
         * вы будете рады смотреть на код сверху после того как увидите код ниже!
         * 
         *             Бегите глупцы!!!!!
         *              
         *              
